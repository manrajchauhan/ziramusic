...
import DashboardHeader from "../components/user/Header";
  ...
  return (
    <Providers>
      <div className="flex h-screen bg-[#121212] text-white overflow-hidden">
        ...
        >
          <div
            className={`absolute top-0 left-0 w-64 h-full bg-[#1a1a1a] shadow-xl p-4 transform transition-transform duration-300 ${
